...
export default async function decorate(block) {
  ...
  if (placeholder) {
    ...
    wrapper.className = 'video-centered-placeholder';
    ...
    if (!autoplay) {
      ...
      wrapper.insertAdjacentHTML(
        'beforeend',
        `<div class="video-centered-placeholder-play"><button type="button" title="${ariaLabel}" aria-label="${ariaLabel}"></button></div>`,
      );
